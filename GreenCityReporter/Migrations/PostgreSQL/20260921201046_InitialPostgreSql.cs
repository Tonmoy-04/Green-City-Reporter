        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DonorName = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    ...
                    SenderPhone = table.Column<string>(type: "character varying(11)", maxLength: 11, nullable: false),
                    ...
                    GatewayStoreId = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    BankTransactionId = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: true),
                    ValidationId = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: true),
                    GatewayPaymentType = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: true),
                    CheckoutKey = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                    ReceiptToken = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                    ...
                    ReceiptEmailSentAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    EmailAttempts = table.Column<int>(type: "integer", nullable: false),
                    EmailNextAttemptAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    EmailLeaseUntil = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "text", nullable: false),
                    AISummary = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Donations_PaymentMethod_TransactionId",
                table: "Donations",
                columns: new[] { "PaymentMethod", "TransactionId" },
                unique: true);
